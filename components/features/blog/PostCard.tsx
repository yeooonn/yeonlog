...
export function PostCard({ post }: PostCardProps) {
  return (
    <Card className="group bg-card/50 border-border/40 overflow-hidden border py-0 backdrop-blur-sm transition-all duration-300 hover:scale-[1.02] hover:shadow-lg">
      {post.coverImage && (
